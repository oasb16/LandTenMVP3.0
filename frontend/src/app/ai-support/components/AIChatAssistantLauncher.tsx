      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed right-0 top-0 bottom-0 w-full sm:w-[480px] h-full bg-white dark:bg-gray-900 border-l border-gray-200 dark:border-gray-700 shadow-2xl overflow-hidden z-50 flex flex-col"
